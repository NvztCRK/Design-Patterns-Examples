...
public class App {
    ...
    public static void main(String[] args) {
        ...
        customer.payBill();
        LOGGER.info("Waiter brings bill and Customer ask that may I pay with Cryto Coins?!");
        customer.changePaymentStrategy(new CryptoCoinPaymentStrategy());
        customer.payBill();

        //with JAVA 8
        LOGGER.info("Waiter brings POS!");
        customer.changePaymentStrategy(() -> LOGGER.info("Customer paid bill by using Debit Card!"));
        customer.payBill();
